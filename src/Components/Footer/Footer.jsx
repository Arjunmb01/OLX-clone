...
const Footer = () => {
  ...
  const olxLinks = [
    ...
    { name: 'Help', url: '#' },
    { name: 'Sitemap', url: '#' },
    { name: 'Legal & Privacy Information', url: '#' },
    { name: 'Vulnerability Disclosure Program', url: '#' }
  ];
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              {popularLocations.map((location, index) => (
                <li key={index}>
                  <a href="#" className="text-gray-500 hover:text-gray-700 text-sm leading-relaxed">
                    {location}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-1.5">
              {aboutLinks.map((link, index) => (
                <li key={index}>
                  <a href={link.url} className="text-gray-500 hover:text-gray-700 text-sm leading-relaxed">
                    {link.name}
                  </a>
                </li>
              ))}
      ...
      <div className="bg-sky-600" style={{ backgroundColor: '#004896' }}>
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="flex flex-wrap items-center justify-around gap-8 mb-8">
            ...
            <div className="text-3xl font-bold">OLX</div>
            <div className="text-base font-medium">CarWale</div>
            <div className="text-base font-medium">BikeWale</div>
            <div className="text-base font-medium">CarTrade</div>
